...
static const mozilla::Module::CIDEntry kHotkeyCIDs[] = {
    { &kSONGBIRD_GLOBALHOTKEYS_CID, false, NULL, CGlobalHotkeysConstructor },
    { NULL }
};

static const mozilla::Module::ContractIDEntry kHotkeyContracts[] = {
    { SONGBIRD_GLOBALHOTKEYS_CONTRACTID, &kSONGBIRD_GLOBALHOTKEYS_CID },
    { NULL }
};

static const mozilla::Module HotkeyModule = {
...
NSMODULE_DEFN(nsHotkey) = &HotkeyModule;
